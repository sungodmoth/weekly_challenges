	...
	% BACKGROUND
        ...
        \begin{scope}[transparent]
            \node (nametag) at (0,-5.5) [rectangle, draw, inner sep=0, fontscale=40] {
                \includegraphics[height=1.5cm]{Images/#3}\itshape\bfseries{~~#3}};
        ...
        \begin{scope}
            ...
            \node at (pfp) {\includegraphics[height=1.5cm]{Images/#3}};
        \end{scope}
...
\newcommand{\Announcement}[9]{
	...
	% SETTING IMAGE RATIO
        ...
        \node at (canvas.north) {\includegraphics[height=1.8cm]{Images/GA_icon}};
...
\newcommand{\Pollcase}[9]{
	...
	\node (icon) at (colorbanner.east) [anchor=east] {\includegraphics [height=1cm] {Images/GA_logo}};
